...
tf.flags.DEFINE_string("conciseness_train_labels_file", '../data/training/conciseness_train.labels', "Labels for the conciseness training data.")
...
y_labels = read_data(FLAGS.conciseness_train_labels_file)
